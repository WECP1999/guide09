...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch(
        "https://guia09dps.000webhostapp.com/apiusuario.php?comando=autenticar&usuario=" +
          this.state.usuario +
          "&contrasena=" +
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    fetch(
      "https://guia09dps.000webhostapp.com/api.php?comando=editar&nombre=" +
        this.state.nombre +
        "&descripcion=" +
  ...
  Eliminar() {
    fetch(
      "https://guia09dps.000webhostapp.com/api.php?comando=eliminar&id=" +
        this.state.id,
      {
        method: "GET",
      }
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    fetch(
      "https://guia09dps.000webhostapp.com/api.php?comando=agregar&nombre=" +
        this.state.nombre +
        "&descripcion=" +
        this.state.descripcion +
        "&cantidad=" +
